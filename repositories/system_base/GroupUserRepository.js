			...
			ormDB.CustodianWeb.authenticate()
				...
				.then((r) => { 
					...
					for(let i=0; i<r.length; i++) {
						returnList.push({
							"u_id": 			r[i]["Users.Id"],
							"u_employee_id": 	r[i]["Users.Employee_Id"],
							"e_user_name": 		r[i]["Users.Employees.User_Name"].toString().trim(),
							"d_dept_id":		r[i]["Users.Employees.Depts.Dept_No"],
							"d_dept_name":		r[i]["Users.Employees.Depts.Dept_Na"],
						});
					}
					resolve(returnList); 
				})
