 ...
 * @module services/system_base/GroupPermissionService.js
 */
...
module.exports.deleteGroupPermissions = async (req, res, next) => {
	...
	try
	{
		...
		if(req.body.data.hasOwnProperty("group_permission_auth")) conditions.Auth = req.body.data.group_permission_auth;
